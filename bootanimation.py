...
# ================= 配置 =================
ZIP_PATH = sys.argv[1] if len(sys.argv) > 1 else "bootanimation.zip"
TEMP_DIR = "boot_temp"
WINDOW_NAME = "Hello"
# 音频同步补偿系数（可微调，默认1.0）
...
def find_sound():
    targets = ["bootaudio.mp3", "start.wav", "boot.wav" ,"bootaudio.ogg" ,"bootaudio.wav" ,"start.wav" ,"boot.wav" ,"start.ogg" ,"boot.ogg"]
